...
namespace DSL
{
    ...
    {
        private readonly List<Func<string, string>> _additonalTransformers = new List<Func<string, string>>();
        ...
        {
            _additonalTransformers.Clear();
        }
        public virtual string Transform(string str, Reqnroll.ScenarioContext context)
        {
